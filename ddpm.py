...
class Diffusion_stage1(object):
    _defaults = {
        "model_path": './logs/model_stage1.pth',
        "channel"           : 64,
        "input_shape"       : (64, 64),
        "schedule"          : "linear",
        "num_timesteps"     : 1000,
    ...
    def generate(self):
        ...
        self.net    = GaussianDiffusion(UNet(3, self.channel, input_num=6), self.input_shape, 3, betas=betas)
...
class Diffusion_stage2(object):
    _defaults = {
        "model_path": './logs/model_stage2.pth',
        "channel": 64,
        "input_shape": (64, 64),
        "schedule": "linear",
        "num_timesteps": 1000,
    ...
    def generate(self):
        ...
        self.net = GaussianDiffusion(UNet(3, self.channel, input_num=2), self.input_shape, 3, betas=betas)
